	...
	return (
		<div className='gallery'>
			<div className='images'>
				...
				<img
					src={kitchen}
					alt='view of kitchen cooking space (sink, stove, fridge, microwave, cabnets)'
				/>
				<img src={bathroom} alt='View of bathroom toilet, sink and shower' />
				<img
					src={customerbook}
					alt='Review left by customer in a book for reviews'
				/>
				<img
					src={bedroomtwo}
					alt='View of rustic bedroom from footer of master bed'
				/>
				<img src={waffles} alt='Tasty breakfast waffles and berries' />
				<img
					src={backdoor}
					alt='Outside view of cabin looking towards the back door'
				/>
			</div>
